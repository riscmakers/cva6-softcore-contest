...
set_property verilog_define {{RISCMAKERS_DCACHE=1} {RISCMAKERS_ICACHE=1}} [get_filesets sim_1]
# set_property verilog_define RISCMAKERS_ICACHE=1 [get_filesets sim_1]
# set_property verilog_define RISCMAKERS_DCACHE=1 [get_filesets sim_1]
